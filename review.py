...
def parse():
    ...
    parser = argparse.ArgumentParser(
        description="ProjectD WAF testing tool")
    ...
    parser.add_argument('-t', '--target', type=str, required=True,
                        help='target\'s url and "projectD" where the payloads will be replace.\nFor instance: -t "http://<YOUR_HOST>/?param=projectD"')
    ...
    parser.add_argument('-SS', '--SSTI', action="store_true",
                        help="testing WAF by executing SSTI payloads")
    ...
    if args.footprinting: 
        ...
        if args.fuzz:  # fuzzing
            ...
            return ['SS', target, path, out, cookies]
